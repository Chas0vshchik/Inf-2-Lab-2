#ifndef INF_2_LAB_2_LISTSEQUENCE_H
#define INF_2_LAB_2_LISTSEQUENCE_H
...
public:
    ...
    ListSequence(const ListSequence &other) : data(new LinkedList<T>(*(other.data))), size(other.size) {}
...
protected:
    ...
    ListSequence(LinkedList<T> *list, const size_t size) : data(list), size(size) {}
};

#endif //INF_2_LAB_2_LISTSEQUENCE_H